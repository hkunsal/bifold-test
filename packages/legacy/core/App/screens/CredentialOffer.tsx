    ...
    return (
      ...
      >
        ...
        <View style={{
          ...
          justifyContent: 'space-between',  // Distributes space evenly at both ends
        }}>
          <View style={[styles.footerButton, {flex: 1, marginRight: 8}]}>  
            <Button
          ...
          <View style={[styles.footerButton, {flex: 1, marginLeft: 8}]}>  
            <Button
