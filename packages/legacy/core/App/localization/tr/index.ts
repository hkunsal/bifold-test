...
const translation = {
  "Global": {
    ...
    "Continue": "Devam Et",
    "Info": "Bilgi",
    "ThisDecisionCannotBeChanged.": "Bu karar değiştirilemez.",
    "Failure": "Hata",
    "Success": "Başarılı",
  ...
  "Error": {
    ...
    "Problem": "Bir problem oluştu.",
    "ErrorCode": "Hata kodu",
    "Title1024": "Kimlik bilgisi kabul edilemedi",
  ...
  "Terms": {
    ...
    "IAgree": "Onaylıyorum",
    "Attestation": "Kullanım koşullarını okudum, anladım ve kabul ediyorum.",
  },
  "Tour": {
  ...
  "PINEnter": {
    "EnterPIN": "Cüzdan PIN'inizi giriniz.",
    "Unlock": "Kilidi Aç",
    "Or": "Or",
  ...
  "Credentials": {
    ...
    "EmptyList": "Cüzdanınız boş. Eklenen kimlikleriniz burada görüntülenecektir.",
    "IssuedBy": "Issued by",
  ...
  "Home": {
    ...
    "OneNotification": "1 Bildirim",
    "CountNotifications": "{{ count }} Bildirimler",
    "NoNewUpdates": "Yeni bildiriminiz yok.",
    "NoCredentials": "Cüzdanınızda kimlik verisi bulunmuyor.",
    "SeeAll": "Tümünü Gör",
    "YouHave": "You have",
    "Credential": "credential",
    "Credentials": "credentials",
    "InYourWallet": "Cüzdanınızda",
    "EmptyWalletMessage": "Cüzdanınız boş",
    "AddedDocuments": "Eklenen Belgelerim",
  },
  "Scan": {
  ...
  "CredentialOffer": {
    ...
    "IsOfferingYouACredential": "Kimlik işleminizi tamamlamak için lütfen bilgilerinizi kontrol edin.",
  ...
  "Loading": {
    "TakingTooLong": "Bu işlem beklenenden uzun sürüyor. Ana sayfaya dönebilir ya da beklemeye devam edebilirsiniz.",
